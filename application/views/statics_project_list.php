      ...
      <div class="am-u-sm-12">
	    ...
	    <?php foreach ($list as $item):?>
	      ...
	      <td><?php echo $item['create_time']?></td>
			...
			<button type="button" class="am-btn am-btn-default am-btn-xs am-text-secondary" onclick="window.location.href='/statics/result?id=<?php echo $item['id']?>'"><span class="am-icon-check"></span>信息汇总</button>
                  </div>
                </div>
              </td>
            </tr>
