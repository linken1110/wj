...
<div class="g_subheader" style="position:absolute">
        <div class="g_content">
            ...
            <div id="change_view_type" class="change_view_type">
                <a href="/main/indexGrid" class="list_type list_type_grid active" data-type="grid">
                    <i class="ico ico_grid"></i>网格视图
                </a>
                <a href="/main/index" class="list_type list_type_table" data-type="table">
    ...
    <div id="container" class="g_container" style ="margin-top:60px;">
        ...
        <div id="list_view_container" class="list_view_container grid_type">
            <div class="list_table_head">
                <div class="title sort_btn" data-field="title" data-order="1">问卷<span class="arrow">↓</span></div>
                ...
                <div class="recycle sort_btn" data-field="recycle" data-order="1">访问量<span class="arrow">↓</span></div>
		...
		<span id="survey_<?php echo $item['id']?>" data-id="<?php echo $item['id']?>" class="survey_item"> <img class="thumbnail" src="../../assets/image/wj/159748_s.jpg" alt="问卷标题"> <div class="title_wrap"> <div class="title" title="<?php echo $item['name']?>"> <a href="/main/survey_detail?id=<?php echo $item['id']?>" class="edit_survey">  <?php if($item['status']==1 ){?> <i class="status ico ico_green_circle"></i><?php }else{?><i class="status ico ico_red_circle"></i><?php }?> <?php echo $item['name']?>(<?php echo $item['id']?>)   </a> </div> </div> <div class="status_col"> <a href="/survey_result/home_list?survey_id=<?php echo $item['id']?>" <i>上传数量</i> </div> <div class="more_operations"> <i><?php echo $item['all']?></i> </a></div> <div class="recycle"><?php echo $item['all']?></div>   <div class="create_time"><?php echo $item['create_date']?></div></span>
		<?php endforeach;?>
		</div>
        </div>
