...
<div class="am-cf admin-main">
  ...
  <div class="am-cf am-padding">
    <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">增加地铁</strong> </div>
  </div>
...
<div class="am-tabs-bd">
	...
	<form class="am-form" action="/subtrain/add" id="my_form" method="post">
	...
	<input type="hidden" value="" name="station_list" id="station_list" />
		...
		<input type="text" name="name" value="" class="am-form-field am-input-sm" style="float:none">
          </div>
        </div>
	<div id ="tab3" ><form class="am-form"></form></div>
