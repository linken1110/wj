      ...
      <div class="am-u-sm-12">
	    ...
	    <?php foreach ($list as $item):?>
	      ...
	      <td><?php echo $item['create_time']?></td>
			...
			<button type="button" class="am-btn am-btn-default am-btn-xs am-text-secondary" onclick="window.location.href='/survey_result/index?id=<?php echo $item['id']?>'"><span class="am-icon-check"></span>问卷结果</button>
                  </div>
                </div>
              </td>
            </tr>
