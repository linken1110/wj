      ...
      <div class="am-u-sm-12">
	    ...
	    <?php foreach ($list as $item):?>
	      ...
	      <td><?php echo $item['create_time']?></td>
			...
			<button type="button" class="am-btn am-btn-default am-text-secondary" onclick="window.location.href='/statics/test?id=<?php echo $item['id']?>'">户信息导出</button>
			<button type="button" class="am-btn am-btn-default " onclick="window.location.href='/statics/test1?id=<?php echo $item['id']?>'">个人信息导出</button>
			<button type="button" class="am-btn am-btn-default am-text-danger" onclick="window.location.href='/statics/test2?id=<?php echo $item['id']?>'">出行链信息导出</button>
                  </div>
                </div>
              </td>
            </tr>
